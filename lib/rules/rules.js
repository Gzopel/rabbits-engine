...
const calculateMovePosition = (from, to, moveSpeed) => {
  ...
  const r =vectorAdd(from,mutiplyVectorFromScalar(normalized, moveSpeed));
  return r;
}
...
export class RuleBook {
  ...
  walk = (character, position) => {
    ...
    const collision = calculateFirstCollisionPosition(character, nextPosition, this.characters);
    if (collision) {
      return [{
