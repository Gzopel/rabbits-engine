...
export class Character {
  ...
  getViewRange() {
    return 100 + 40 * (this.get('attributes.mental.perception') + this.get('abilities.talents.alertness'));
  }
  ...
  getMoveSpeed() {
     ...
     */
    return 10 + 2 * (this.get('attributes.physical.dexterity') + this.get('abilities.talents.athletics'));
  }
