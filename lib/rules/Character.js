...
export class Character {
  ...
  getViewRange() {
    return this.get('attributes.mental.perception') + this.get('abilities.talents.alertness');
  }
  ...
  getMoveSpeed() {
     ...
     */
    return this.get('attributes.physical.dexterity') + this.get('abilities.talents.athletics');
  }
