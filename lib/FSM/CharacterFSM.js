...
export class CharacterFSM {
  ...
  handleEvent = (eventData) => {
    ...
    const next = this.transitions[eventData.event][this.state.action] ?
      this.transitions[eventData.event][this.state.action](this, eventData) :
      this.transitions[eventData.event]['*'](this, eventData);
