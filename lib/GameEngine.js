...
export class GameEngine {
  ...
  getSnapshot() { // TODO: This should take a character as an argument and return only characters in its surroundings
    ...
    for (let fsm of this.fsms.values()) {
      ...
      delete state.next;
      characters.get(fsm.character.id).state = state;
    }
  }
}
